...
export default function Footer() {
  ...
  return (
    <footer className="bg-background-light py-12 border-t border-primary/20">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#intro" className="text-text-muted hover:text-primary transition-colors">
                  About Us
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-text-muted">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:ryan@rhythmandbrewspr.com" className="hover:text-primary transition-colors">
                  ryan@rhythmandbrewspr.com
                </a>
              </li>
            </ul>
          </div>
        ...
        {/* Social Media Links */}
        <div className="flex justify-center gap-6 mb-8 pt-8 border-t border-primary/10">
          <a
            href="https://www.instagram.com/rhythmandbrewsaguadilla"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="mailto:ryan@rhythmandbrewspr.com"
            className="text-text-muted hover:text-primary transition-colors"
            aria-label="Email"
          >
